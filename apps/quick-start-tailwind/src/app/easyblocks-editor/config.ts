import { EasyblocksBackend, Template } from "@easyblocks/core";
import { Config } from "@easyblocks/core";
import {
  DummyBannerDefinition,
  DummySelectableDefinition,
} from "./definitions";
...
export const easyblocksConfig: Config = {
  ...
  components: [DummyBannerDefinition, DummySelectableDefinition],
  tokens: {
    colors: [
      {
        id: "black",
